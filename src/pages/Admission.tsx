      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-justify">
            <h1 data-aos="fade-up" data-aos-duration="600" className="title-font sm:text-4xl text-3xl mb-4 font-medium text-[#ffc847] mt-4 font-vidaloka">
              Admission Open
              <br className="hidden lg:inline-block" />
            </h1>
            <p data-aos="fade-up" className="mb-8 text-white leading-relaxed font-karla">
            ...
            <div className="">
              <h2 data-aos="fade-left" className="font-semibold text-lg text-[#ffc847] font-martel">
                Why Choose Jaycee Bal Mandir ?
              </h2>
              <ul className="px-4 mt-2 mb-4 text-white list-disc text-justify">

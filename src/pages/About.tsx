...
import schoolImg from "../assets/about_pic.jpg"
const About = () => {
  return (
    <>
      <div className="py-16">
        <div className="container m-auto px-6 md:px-12 xl:px-6">
          <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
            ...
            <div className="md:7/12 lg:w-6/12">
              ...
              <p className="mt-4 font-karla text-justify text-white">
              ...
              <h2 className="text-xl mt-6 text-[#ffc847] font-bold md:text-4xl font-martel">
                Our Vision
              </h2>
              <p className="mt-4 font-karla text-justify text-lg text-white">
              We believe in ensuring opportunity resources and safe learning environment to all students.
              </p>
              <h2 className="text-xl mt-6 text-[#ffc847] font-bold md:text-4xl font-martel">
                Our Moto
              </h2>
              <p className="mt-4 text-lg text-justify font-karla text-white">

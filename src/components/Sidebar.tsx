...
const Dropdown: React.FC<DropdownProps> = ({ title, icon, children, toggleSidebar }) => {
  ...
  return (
    <div>
      <button
        className="flex bg-neutral-900 w-full gap-2 items-center justify-between hover:bg-neutral-800 hover:text-neutral-100 p-2 rounded-lg transition-colors"
          ...
          {React.Children.map(children, (child) => {
            if (React.isValidElement(child)) {
              return React.cloneElement(child as React.ReactElement<any>, {
                className: `${child.props.className} block p-2 hover:bg-neutral-800 hover:text-neutral-100 bg-neutral-900 rounded-lg`,
  ...
  return (
    <>
      <AnimatePresence>
        ...
        <motion.div
          className="fixed top-0 right-0 z-50 h-screen w-72 p-4 bg-neutral-950 shadow-lg overflow-y-auto"
          ...
          <nav>
            ...
            <ul className="space-y-2 mt-6">
              <li>
                <Link to="/" className='flex bg-neutral-900 gap-2 items-center hover:bg-neutral-800 hover:text-neutral-100 p-2 rounded-lg transition-colors' onClick={toggleSidebar}>
                  <LuHome />Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/admission" className='flex gap-2 bg-neutral-900 items-center hover:bg-neutral-800 hover:text-neutral-100 p-2 rounded-lg transition-colors' onClick={toggleSidebar}>
                  <LuSchool2 />Admission
                </Link>
              </li>
              <li>

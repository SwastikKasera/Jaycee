...
const StudentCard: React.FC<StudentInterface> = ({ name, standard, marks, photo, year, rank }) => {
  return (
    <div className="bg-white border-2 h-fit border-secondary transition-colors relative rounded-lg shadow-md p-4 max-w-sm mx-auto">
      <div className="flex items-center mb-4">
        ...
        {rank && <p className='bg-primary rounded-full px-3 py-1 absolute right-3 top-4 text-white'>{rank}</p>}
      </div>
